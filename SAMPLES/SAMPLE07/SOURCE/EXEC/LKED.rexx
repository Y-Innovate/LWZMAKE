...
IF g.OBJECT.allocated == 1 THEN DO                                              
   _rc = BPXWDYN("FREE FI("g.OBJECT.ddname")")                                  
   ...
   ELSE DO                                                                      
      g.error = 8                                                               
      IF _rc > 0 THEN _rc = D2X(_rc)                                            
      CALL log 'Free of file 'g.OBJECT.ddname' failed with '_rc                 
   END                                                                          
END                                                                             
                                                                                
IF g.LOAD.allocated == 1 THEN DO                                                
   _rc = BPXWDYN("FREE FI("g.LOAD.ddname")")                                    
   ...
   ELSE DO                                                                      
      g.error = 8                                                               
      IF _rc > 0 THEN _rc = D2X(_rc)                                            
      CALL log 'Free of file 'g.LOAD.ddname' failed with '_rc                   
   END                                                                          
END                                                                             
