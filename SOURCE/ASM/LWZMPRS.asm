...
*
            ...
            ENDIF
*
            IF (CLC,ti4.TFO_tokenType,NE,=A(TOKEN_TYPE_COMMENT)) THEN
               LA    R1,WORKP95
...
*
               ...
               ENDIF
*
               IF (CLC,ti4.TFO_tokenType,NE,=A(TOKEN_TYPE_COMMENT))
                  LA    R1,WORKP98
...
*
               ...
               (CLC,ti6.TFO_tokenType,EQ,=A(TOKEN_TYPE_CLOSECURLY))
                  ...
                  ENDIF
*
                  IF (CLC,ti6.TFO_tokenType,NE,=A(TOKEN_TYPE_COMMENT))
                     LA    R1,WORKP98
...
*
               ...
               WORK=WORKP98,ZSTR=0(,R3)
                  ENDIF
*
                  IF (CLC,ti5.TFO_tokenType,NE,=A(TOKEN_TYPE_COMMENT))
                     LA    R1,WORKP98
