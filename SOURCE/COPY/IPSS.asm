...
IPSS_SetRecipePrefixPtr      DS    A   * Set a new recipe prefix char           
                             DS    0F                                           
...
*                                                                               
         ...
         BASR  R14,R15      * Branch to SetPhase entry point                    
         MEND                                                                   
*                                                                               
         MACRO                                                                  
         IPSS_SetRecipePrefix &OBJECT=,&WORK=,&PREFIX=                          
         L     R15,&OBJECT  * Ptr to Vtbl                                       
         LA    R1,&WORK     * Address execute storage                           
         ST    R15,0(,R1)   * Set 'this' (ptr to Vtbl) as parm 1                
         XR    R14,R14      * Clear R14                                         
         IC    R14,&PREFIX  * Insert recipe prefix                              
         ST    R14,4(,R1)   * Set recipe prefix as parm 2                       
         L     R15,0(,R15)  * Point to start of Vtbl                            
         L     R15,IPSS_SetRecipePrefixPtr-IPSS_Vtbl(,R15)                      
         BASR  R14,R15      * Branch to SetRecipePrefix entry point             
         MEND                                                                   
*                                                                               
* Parser states                                                                 
*                                                                               
